                ...
                <Dialog.Content>
                    ...
                    <Dialog.Body>
                        {typeof message === 'string' ? (
                            <Text mt={0} fontSize="md" color="gray.800" textAlign="center">
                                {message}
                            </Text>
                        ) : (
                        ...
                        {description && (
                            typeof description === 'string' ? (
                                <Text mt={0} fontSize="md" color="gray.600" textAlign="center">
                                    {description}
                                </Text>
                            ) : (
                                <Box mt={0} fontSize="md" color="gray.600" textAlign="center">
                                    {description}
                                </Box>
                            )
                        )}
