            ...
            <Container maxW="600px" p={0}>
                ...
                <Box p={{ base: "20px 15px", md: "30px 20px" }}>
                        ...
                        <Box bg={darkGray} p="20px" borderRadius="8px">
                            <VStack gap={0} align="stretch">
                                ...
                                >
                                    ...
                                    <VStack align="flex-start" gap="5px" flex={1}>
                                        <Text fontWeight="bold" fontSize="16px" color="white">
                                            Abertura e Boas-vindas
                                        </Text>
                                        <Text fontSize="14px" color={lightGray}>
                                            Recepção dos convidados com coquetel de boas-vindas
                                        </Text>
                                    </VStack>
                                </HStack>
                                <HStack
                                ...
                                >
                                    ...
                                    <VStack align="flex-start" gap="5px" flex={1}>
                                        <Text fontWeight="bold" fontSize="16px" color="white">
                                            Painel: O Futuro do Audiovisual Brasileiro
                                        </Text>
                                        <Text fontSize="14px" color={lightGray}>
                                            Mesa redonda com principais executivos e criadores
                                        </Text>
                                    </VStack>
                                </HStack>
                                <HStack
                                ...
                                >
                                    ...
                                    <VStack align="flex-start" gap="5px" flex={1}>
                                        <Text fontWeight="bold" fontSize="16px" color="white">
                                            Apresentação das Novidades 2026
                                        </Text>
                                        <Text fontSize="14px" color={lightGray}>
                                            Exclusivo: primeiras revelações dos próximos lançamentos
                                        </Text>
                                    </VStack>
                                </HStack>
                                <HStack gap="15px" py="15px" align="flex-start">
                                    <Text
                                        color={netflixRed}
                                        fontWeight="bold"
                                        fontSize="14px"
                                    ...
                                    <VStack align="flex-start" gap="5px" flex={1}>
                                        <Text fontWeight="bold" fontSize="16px" color="white">
                                            Networking e Celebração
                                        </Text>
                                        <Text fontSize="14px" color={lightGray}>
                                            Momento de confraternização e networking
                                        </Text>
                                    </VStack>
                                </HStack>
                            </VStack>
                    ...
                    <VStack gap="15px" mb="40px" align="stretch">
                        ...
                        >
                            {[
                                { name: "Ana Silva", title: "Diretora de Conteúdo", letter: "A" },
                                { name: "Bruno Santos", title: "Produtor Executivo", letter: "B" },
                                { name: "Carla Oliveira", title: "Roteirista", letter: "C" },
                            ].map((speaker, idx) => (
                                <Box
                                    key={idx}
                                    flex={{ base: "1", md: "1" }}
                                ...
                                >
                                    ...
                                    <Text fontWeight="bold" fontSize="14px" color="white" mb="5px">
                                        {speaker.name}
                                    </Text>
